...
class AppDelegate: UIResponder, UIApplicationDelegate,UNUserNotificationCenterDelegate {
    ...
    var initialLatValue:Double = 0.0
    var initialLongValue:Double = 0.0
    ...
    func userNotificationCenter(_ center: UNUserNotificationCenter, didReceive response: UNNotificationResponse, withCompletionHandler completionHandler: @escaping () -> Void) {
        ...
        NotificationCenter.default.post(name: Notification.Name(rawValue: "OpenListPage"), object: nil)
...
//        self.window?.rootViewController = navBar
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "SolulabTestProject")
